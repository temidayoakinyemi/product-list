...
const ProductItem = ({ image, category, title, price, addToCart, cartItem }) => {
    ...
    <div className="firstproduct">
      ...
      {quantity === 0 ? (
        <button
          ...
          onClick={() => addToCart({ image, category, title, price, quantity: 1 })}
        >
          <img src={cart} alt="cart" /> Add to cart
        </button>
      ) : (
        <div className="productaddtocart active">
          <button className="counter-btn" onClick={() => addToCart({ title, change: -1 })}>
...
const Product = () => {
  ...
  const products = [
    { image: productimage1, category: "Waffle", title: "Waffle with Berries", price: 6.5 },
    { image: productimage2, category: "Crème Brûlée", title: "Vanilla Bean Crème Brûlée", price: 7.0 },
    { image: productimage3, category: "Macaron", title: "Macaron Mix of Five", price: 8.0 },
    { image: productimage4, category: "Tiramisu", title: "Classic Tiramisu", price: 5.5 },
    { image: productimage5, category: "Baklava", title: "Pistachio Baklava", price: 4.0 },
    { image: productimage6, category: "Pie", title: "Lemon Meringue Pie", price: 5.0 },
    { image: productimage7, category: "Cake", title: "Red Velvet Cake", price: 4.5 },
    { image: productimage8, category: "Brownie", title: "Salted Caramel Brownie", price: 5.5 },
    { image: productimage9, category: "Panna Cotta", title: "Vanilla Panna Cotta", price: 6.5 },
  ];

  const handleAddToCart = ({ image, category, title, price, quantity, change }) => {
    setCartItems((prev) => {
    ...
    <div className="product">
      <div className="product-content">
        ...
        <div className="cartresult">
          ...
          {cartItems.length === 0 ? (
            <>
              <img className="emptyillustration" src={empty_illustration} alt="empty cart" />
              ...
              <div className="delivery">
                <div className="carbonimgp">
                  ...
                  <p className="deliveryp">
                    This is a <span className="deliverypspan">Carbon-neutral</span> delivery
                  </p>
                </div>
              </div>

              <button className="confirmorderbtn" onClick={() => setShowPopup(true)}>
                Confirm Order
              </button>
            </>
          )}
        ...
        <>
          ...
          <div className="popup">
            ...
            <div className="popup-items">
              {cartItems.map((item) => (
                <div className="popup-item" key={item.title}>
                  <img src={item.image} alt={item.title} className="popup-item-img" />
                  <div className="popup-item-info">
                    ...
                    <p className="popup-item-line">
                      ...
                      <span className="popup-item-price">@ {formatPrice(item.price)}</span>
            ...
            <div className="popup-total">
              <span>Order Total</span>
              <span className="popup-total-price">{formatPrice(totalPrice)}</span>
            </div>
